...
public class ProductController extends BaseMultipartController<ProductDto, Integer>{
    ...
    @Operation(summary = "upload bulk images", description = "upload multiple images")
    ...
    public ResponseEntity<?> getAllProduct(Pageable pageable){
        var productDtos = this.productService.findAll(pageable);

        var response = ApiResponse.builder()
                        .status(HttpStatus.OK.toString())
                        .message("getAllProductPaging")
                        .data(productDtos)
                        .build();
    ...
    @GetMapping("/search")
    public ResponseEntity<?> getAllProduct(@RequestParam String keyword, Pageable pageable){
        var productDtos = this.productService.findAll(keyword, pageable);

        var response = ApiResponse.builder()
                        .status(HttpStatus.OK.toString())
                        .message("getSearchProduct")
                        .data(productDtos)
                        .build();
    ...
    public ResponseEntity<?> getProductByCategory(@RequestParam String keyword, Pageable pageable){
        var productDtos = this.productService.findAllWithCategory(keyword, pageable);

        var response = ApiResponse.builder()
                        .status(HttpStatus.OK.toString())
                        .message("GetSearchProductCategory")
                        .data(productDtos)
                        .build();
    ...
    public ResponseEntity<?> getProductByName(@RequestParam String keyword){
        var productDtos = this.productService.findProductByProductName(keyword);
