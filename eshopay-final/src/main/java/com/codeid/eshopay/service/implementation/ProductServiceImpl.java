...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<ProductDto> findAll(String search, Pageable pageable) {
        return this.productRepository.findByProductNameIgnoreCase(search, pageable)
                .stream().map(ProductServiceImpl::mapToDto).toList();
    }

    @Override
    public List<ProductDto> findAllWithCategory(String search, Pageable pageable) {
        return this.productRepository.findByCategoryCategoryNameIgnoreCase(search, pageable)
                .stream().map(ProductServiceImpl::mapToDto).toList();
    }

    @Override
    public List<ProductDto> findProductByProductName(String search) {
        return this.productRepository.findProductByProductName(search)
                .stream().map(ProductServiceImpl::mapToDto).toList();
    }
